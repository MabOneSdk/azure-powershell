...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] TriggerRehydrate=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataProtection/backupVaults/{vaultName}/backupInstances/{backupInstanceName}/rehydrate"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Start, @"AzDataProtectionBackupInstanceRehydrate_TriggerExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Description(@"rehydrate recovery point for restore for a BackupInstance")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Generated]
    public partial class StartAzDataProtectionBackupInstanceRehydrate_TriggerExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api202101.IAzureBackupRehydrationRequest _parametersBody= new Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api202101.AzureBackupRehydrationRequest();

        /// <summary>Azure Backup Rehydrate Request</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api202101.IAzureBackupRehydrationRequest ParametersBody { get => this._parametersBody; set => this._parametersBody = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Id of the recovery point to be recovered")]
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string RecoveryPointId { get => ParametersBody.RecoveryPointId ?? null; set => ParametersBody.RecoveryPointId = value; }

        /// <summary>Priority to be used for rehydration. Values High or Standard</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Priority to be used for rehydration. Values High or Standard")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Category(global::Microsoft.Azure.PowerShell.Cmdlets.DataProtection.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Support.RehydrationPriority))]
        public Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Support.RehydrationPriority RehydrationPriority { get => ParametersBody.RehydrationPriority ?? ((Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Support.RehydrationPriority)""); set => ParametersBody.RehydrationPriority = value; }

        /// <summary>Retention duration in ISO 8601 format i.e P10D .</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Retention duration in ISO 8601 format i.e P10D .")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Category(global::Microsoft.Azure.PowerShell.Cmdlets.DataProtection.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string RehydrationRetentionDuration { get => ParametersBody.RehydrationRetentionDuration ?? null; set => ParametersBody.RehydrationRetentionDuration = value; }
        ...
        /// <returns>
        /// a duplicate instance of StartAzDataProtectionBackupInstanceRehydrate_TriggerExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Cmdlets.StartAzDataProtectionBackupInstanceRehydrate_TriggerExpanded Clone()
        {
            var clone = new StartAzDataProtectionBackupInstanceRehydrate_TriggerExpanded();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'BackupInstancesTriggerRehydrate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.BackupInstancesTriggerRehydrate(ResourceGroupName, SubscriptionId, VaultName, BackupInstanceName, ParametersBody, onNoContent, onDefault, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="StartAzDataProtectionBackupInstanceRehydrate_TriggerExpanded" /> cmdlet class.
        /// </summary>
        public StartAzDataProtectionBackupInstanceRehydrate_TriggerExpanded()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api202101.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, SubscriptionId=SubscriptionId, VaultName=VaultName, BackupInstanceName=BackupInstanceName, body=ParametersBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, SubscriptionId=SubscriptionId, VaultName=VaultName, BackupInstanceName=BackupInstanceName, body=ParametersBody })
                    {
