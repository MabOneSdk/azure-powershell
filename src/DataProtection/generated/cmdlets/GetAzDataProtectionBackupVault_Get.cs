...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzDataProtectionBackupVault_Get" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.BackupVaultsGet(VaultName, ResourceGroupName, SubscriptionId, onOk, onDefault, this, Pipeline);
